...
float Volume::biLinearInterpolate(const glm::vec2& xyCoord, int z) const
{
    ...
    float c00 = linearInterpolate(getVoxel(bottomLeftCoord.x, bottomLeftCoord.y, z), getVoxel(bottomRightCoord.x, bottomRightCoord.y, z), a);

    float c10 = linearInterpolate(getVoxel(topLeftCoord.x, topLeftCoord.y, z), getVoxel(topRightCoord.x, topRightCoord.y, z), a);
